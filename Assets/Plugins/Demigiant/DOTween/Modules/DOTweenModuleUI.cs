...
namespace DG.Tweening
{
    public static class DOTweenModuleUI
    {
        ...
        public static void TextAnimationByMDA(this TMP_Text text, string textChange)
        {
            text.DOFade(0f, 1 / 2).OnComplete(() =>
            {
                text.text = textChange;
                text.DOFade(1f, 1 / 2);
            });
        }
        public static void TextAnimationKillByMDA(this TMP_Text text, string textChange)
        {
            text.DOFade(0f, 1 / 2).OnComplete(() =>
            {
                text.text = textChange;
                text.DOFade(1f, 2f).OnComplete(() => { text.DOFade(0f, 2f); });
            });
        }
    }
}
